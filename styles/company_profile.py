...
def apply_company_profile_css() -> None:
    ...
    st.markdown(
        ...
        @keyframes price-source-button-spin {
        ...
        .stApp:has(.company-profile-active)
        .st-key-price_review_previous button,
        .stApp:has(.company-profile-active)
        .st-key-price_review_next button {
            width: 100% !important;
            height: 32px !important;
            min-height: 32px !important;
            padding: 0 10px !important;
        ...
        .stApp:has(.company-profile-active)
        [class*="st-key-price_catalog_row_"] [data-testid="stAlert"],
        .stApp:has(.company-profile-active)
        [class*="st-key-price_review_row_"] [data-testid="stAlert"] {
            min-height: 36px;
            padding: 7px 12px !important;
        }
        ...
        .stApp:has(.company-profile-active)
        .st-key-price_catalog_shell > [data-testid="stVerticalBlock"] {
            gap: 0 !important;
        }
        ...
        .price-catalog-department-empty {
            min-height: 58px;
            padding: 20px 38px;
            border-top: 1px solid var(--color-border-soft);
            color: var(--color-text-muted);
        ...
        .stApp:has(.company-profile-active) .st-key-price_source_library_section {
            margin-top: 18px;
        }

        .stApp:has(.company-profile-active)
        .st-key-price_source_library_section [data-testid="stExpander"] {
            overflow: hidden;
            border: 1px solid var(--color-border-soft) !important;
            border-radius: 18px !important;
            background: var(--color-surface) !important;
        ...
        .stApp:has(.company-profile-active)
        .st-key-price_source_library_section [data-testid="stExpander"] summary {
            min-height: 58px;
