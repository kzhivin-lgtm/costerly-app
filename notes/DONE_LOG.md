...
v3.2.2 Users invitation link visual checkpoint: replaced the loose owner-only heading and code block with the existing Users table-card primitive, kept the URL clickable, matched the EMAIL header treatment, and applied the accepted compact 12px section gap; the user accepted the rendered preview and 186 tests passed, завершена 19.09
