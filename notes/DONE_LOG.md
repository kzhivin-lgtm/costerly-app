...
v3.1.10 Company Profile navigation production checkpoint: restored the full-width tab rail on the lazy stateful tabs, removed the React Aria red selection indicator, made only the selected tab bold, renamed Price List to Price Lists, standardized Overhead Expenses copy, and preserved working Save Overhead Expenses; production screenshots confirm the changes, while a small residual Overhead Expenses vertical offset remains explicitly open. Checkpoint `9ab5814`, 165 tests passed, зафиксировано 19.09
